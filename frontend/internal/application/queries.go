...
type Queries interface {
	...
	OrderDraft(ctx context.Context, credentials Credentials, categoryID int64) (contract.OrderDraft, error)
	OrderDrafts(ctx context.Context, credentials Credentials) ([]contract.OrderDraft, error)

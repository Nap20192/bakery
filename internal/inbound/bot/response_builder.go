...
func (responseBuilder) Start() string {
	return "<b>orderbot</b>\n\n" +
		"<b>Локация</b>\n" +
		"Выберите магазин или цех через кнопки ниже. Заказы создают только магазины: от выбранного магазина в цех.\n\n" +
		"<b>Формат заказа</b>\n" +
		"Отправьте весь batch одним сообщением.\n" +
		"Позиция: <code>код название количество</code>\n" +
		"Пример: <code>15647 Сосиска в тесте 5</code>\n\n" +
		"<b>Дата выполнения</b>\n" +
		"Дата указывается отдельной строкой без слов: <code>13.05.2026</code>\n" +
		"Если дату не указать, бот поставит завтра. Прошедшая дата считается ошибкой.\n\n" +
		"<b>Количество</b>\n" +
		"Можно использовать целые и дробные числа: <code>5</code>, <code>1.5</code>, <code>1,5</code>\n" +
		"Заказное количество пишется через плюс: <code>5+5</code>\n" +
		"В <code>5+5</code> первое число обычное, второе заказное. В производство идет сумма.\n\n" +
		"<b>Заголовки</b>\n" +
		"Заголовки разделов можно оставлять в заказе, если они написаны заглавными буквами:\n" +
		...
		"/start - выбрать локацию и показать помощь\n" +

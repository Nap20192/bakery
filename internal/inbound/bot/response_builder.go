...
func (responseBuilder) Help() string {
	return "<b>Инструкция orderbot</b>\n\n" +
		...
		"Если отправить позицию с тем же названием ещё раз, количество обновится.\n" +
		"Пример:\n" +
		"<code>Сосиска в тесте 8</code>\n\n" +
		"Чтобы удалить позицию, отправьте её с количеством <code>0</code>:\n" +
		"<code>Сосиска в тесте 0</code>\n\n" +
